[![Build Status](https://dev.azure.com/ebube-devops/flaskProject/_apis/build/status/blossom2016.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/ebube-devops/flaskProject/_build/latest?definitionId=1&branchName=master)
